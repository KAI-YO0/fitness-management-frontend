<template>
    ...
    <div class="lg:flex lg:px-24 md:px-24 py-16  ">
        ...
        <div class="p-6 lg:p-24  lg:mt-24">
            <div class="uppercase tracking-wide text-2xl text-indigo-500 font-semibold mb-8">SPIN</div>
            <a href="#" class="block mt-1 text-lg leading-tight font-medium text-black hover:underline">SPIN POWER
                is the most popular cycling exercise class</a>
            <p class="mt-2 text-slate-500">Enhance your cycling skills challenging yourself to various riding
                techniques, including speed, time trials, pacing, climbing and sprints This workout enhances both your
                cardiovascular and muscular endurance. Amplifying your cycling power.</p>
        </div>
    </div>
                                ...
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    ...
                                    <div class="col-span-1 sm:col-span-1">
                                        ...
                                        <select id="dayCategory"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                            <option></option>
                                            <option value="FRIDAY 10.00 - 11.00">FRIDAY 10.00 - 11.00</option>
                                            <option value="SATURDAY 13.00 - 14.00">SATURDAY 13.00 - 14.00</option>
