<template>
            ...
            <div class="lg:px-20 mx-auto max-w-screen-2xl    grid lg:grid-cols-2  justify-items-center  ">
                ...
                <div>
                    <div class=" md:py-24 py-10">
                        <img class=" h-[28rem] lg:ml-28   " src="../assets/fit1.png">
                    </div>
                </div>
            </div>
        </section>
    ...
    <div class="lg:flex lg:px-24 md:px-24 py-16 ">
        ...
        <div class="p-6 lg:p-24  lg:mt-24">
            <div class="uppercase tracking-wide text-2xl text-indigo-500 font-semibold mb-8">MIXED TERRAIN SPIN</div>
            <a href="#" class="block mt-1 text-lg leading-tight font-medium text-black hover:underline">MIXED TERRAIN SPIN (Revolutions
                Per Minute) is the most popular cycling exercise class</a>
            <p class="mt-2 text-slate-500"> MIXED TERRAIN SPIN
                Rev up your cardio and strength with indoor cycling! A dynamic class to enhance cardiovascular health,
                lower body strength and endurance. Enjoy the energetic ride with music and varied spinning moves.
                Suitable for all seeking diverse terrains and challenging routes.</p>
        </div>
    </div>
        ...
        <div
            ...
            <figure
                ...
                <blockquote class="max-w-2xl mx-auto pt-8 mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                    <h3 class="text-2xl font-semibold text-gray-900 dark:text-white">Thursday</h3>
            ...
            <figure
                ...
                <blockquote class="max-w-2xl mx-auto pt-8 mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Wednesday</h3>
                                ...
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    ...
                                    <div class="col-span-2 sm:col-span-1">
                                        ...
                                        <select id="classCategory"
                                            ...
                                            <option></option>
                                            <option value="MIXED TERRAIN SPIN">MIXED TERRAIN SPIN</option>
                                    ...
                                    <div class="col-span-1 sm:col-span-1">
                                        ...
                                        <select id="dayCategory"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                            <option></option>
                                            <option value="Thursday 10.00 - 11.00">Thursday 10.00 - 11.00</option>
                                            <option value="Wednesday 13.00 - 14.00">Wednesday 13.00 - 14.00</option>
