<template>
    ...
    <div class="lg:flex lg:px-24 md:px-24 py-16">
        <div class="md:shrink-0 px-20 ">
            <img class=" w-full object-cover md:h-full md:w-64   " src="../assets/rpm.png"
                alt="Modern building architecture">
        </div>
        <div class="p-6 lg:p-24  lg:mt-24">
            <div class="uppercase tracking-wide text-2xl text-indigo-500 font-semibold mb-8">RPM (Revolutions Per
                Minute)</div>
            <a href="#" class="block mt-1 text-lg leading-tight font-medium text-black hover:underline">RPM (Revolutions
                Per Minute) is the most popular cycling exercise class</a>
            <p class="mt-2 text-slate-500"> that we
                see at most
                gyms. which is a simulation of cycling in the form of a road and cycling up a mountain. Accompanied by
                music to
                add fun to the continuous speed by using viscosity as the determining factor for pedaling effort.
                and increasing the difficulty of exerting force from standing while cycling is viscous. It can be said
                to be a
                class where the heart rate skyrockets no matter when you exercise. You will leave feeling rejuvenated.
                Refreshed
                from heavy exertion, burns fat evenly. Plus, she also sculpted both her legs and hips to be firm.</p>
        </div>
    </div>
    ...
    <div class="contrainner   h-full w-auto">
        ...
        <div
            ...
            <figure
                ...
                <blockquote class="max-w-2xl pt-8 mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
            ...
            <figure
                ...
                <button type="button" @click="toggleModal" data-modal-target="crud-modal"
                                ...
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    ...
                                    <div class="col-span-1 sm:col-span-1">
                                        ...
                                        <!-- <select id="dayCategory"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                            <option></option>
                                            <option value="Monday10.00 - 11.00">Monday 10.00 - 11.00</option>
                                            <option :class="b" value="Tuesday13.00 - 14.00">Tuesday 13.00 - 14.00</option>

                                          
                                        </select> -->
                                        <select id="dayCategory"
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
          @change="disableSelectedOption">
    <option></option>
    <option :disabled="selectedDay === 'Monday10.00 - 11.00'" value="Monday10.00 - 11.00">Monday 10.00 - 11.00</option>
    <option :disabled="selectedDay === 'Tuesday13.00 - 14.00'" value="Tuesday13.00 - 14.00">Tuesday 13.00 - 14.00</option>
...
const disableSelectedOption = (event) => {
  selectedDay.value = event.target.value;
};
const toggleModal = () => {
  showModal.value = !showModal.value;
  // เมื่อโมดอลถูกเปิดให้รีเซ็ตค่า selectedDay เป็นค่าว่าง
  if (showModal.value) {
    selectedDay.value = '';
  }
};
