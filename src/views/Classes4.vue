<template>
    ...
    <div class="lg:flex lg:px-24 md:px-24 py-16  ">
        <div class="md:shrink-0 md:px-16 ">
            <img class=" w-full object-cover md:h-full md:w-[28rem] " src="../assets/bodypump1.png"
                alt="Modern building architecture">
        </div>
        <div class="p-6 lg:p-24  lg:mt-24">
            <div class="uppercase tracking-wide text-2xl text-indigo-500 font-semibold mb-8">BODYPUMP</div>
            <a href="#" class="block mt-1 text-lg leading-tight font-medium text-black hover:underline">BODYPUMP (Revolutions
                Per Minute) is the most popular cycling exercise class</a>
            <p class="mt-2 text-slate-500">A full-body barbell workout targeting all major muscle groups. It’s all about
                The Rep Effect. Exhausting muscles with light to moderate weights, performing high reps. Tones and
                shapes the entire body without bulky muscles. While increasing core strength and improving bone health.
                Time to let it rip!</p>
        </div>
    </div>
        ...
        <div
            ...
            <figure
                ...
                <blockquote class="max-w-2xl mx-auto pt-8 mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                    <h3 class="text-2xl font-semibold text-gray-900 dark:text-white">SATURDAY</h3>
            ...
            <figure
                ...
                <blockquote class="max-w-2xl mx-auto pt-8 mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                    <h3 class="text-2xl font-semibold text-gray-900 dark:text-white">FRIDAY</h3>
                                ...
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    ...
                                    <div class="col-span-1 sm:col-span-1">
                                        ...
                                        <select id="dayCategory"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                            <option></option>
                                            <option value="FRIDAY 13.00 - 14.00">FRIDAY 13.00 - 14.00</option>
                                            <option value="SATURDAY 10.00 - 11.00">SATURDAY 10.00 - 11.00</option>
