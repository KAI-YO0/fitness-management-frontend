<template>
  ...
  <div class="lg:flex lg:px-24 md:px-24 py-24">
    <div class="md:shrink-0 px-24 md:px-10 ">
      <img class=" w-full object-cover md:h-full md:max-w-96 " src="../assets/output.png" alt="Modern building architecture">
    </div>
    <div class="p-6 lg:p-24  lg:mt-24">
      <div class="uppercase tracking-wide text-2xl text-indigo-500 font-semibold mb-8">BIKE TOUR</div>
      <a href="#" class="block mt-1 text-lg leading-tight font-medium text-black hover:underline">Bike Tour  is the most popular cycling exercise class.</a>
      <p class="mt-2 text-slate-500"> Suitable for beginners in SpinBike riding. Enjoy cycling to the rhythm of the music in this class. The rhythm of cycling is not very heavy. Moderate speed and light viscosity If a person likes to be cruel You may not enjoy this class. But if any day you want to ride and chill, This class is ideal.</p>
    </div>
  </div>
        ...
        <div
            ...
            <figure
                ...
                <blockquote class="max-w-2xl mx-auto pt-8 mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                    <h3 class="text-2xl font-semibold text-gray-900 dark:text-white">WEDNESDAY</h3>
                                ...
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    ...
                                    <div class="col-span-1 sm:col-span-1">
                                        ...
                                        <select id="dayCategory"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                            <option></option>
                                            <option value="WEDNESDAY10.00 - 11.00">WEDNESDAY 10.00 - 11.00</option>
                                            <option value="THURSDAY13.00 - 14.00">THURSDAY 13.00 - 14.00</option>
