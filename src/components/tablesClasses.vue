    ...
    <main>
      ...
      <div class="grid grid-cols-3 gap-6">
        <li class="p-6 bg-light rounded-lg border-2 flex items-center cursor-pointer bg-gray-100">
          <div
            class="w-14 h-20 rounded-lg flex items-center justify-center bg-light-danger text-danger "
          >
        ...
        <li class="p-6 bg-light rounded-lg border-2 flex items-center cursor-pointer bg-gray-100">
          <div
            class="w-10 h-20 rounded-lg flex items-center justify-center bg-light-danger text-danger"
          >
